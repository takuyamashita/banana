# stg 環境の値。秘密情報は書かない(DB のパスワードは Terraform が生成し、振込 API のキーは Secrets Manager に手で入れる)。
...
api_domain                 = "api.stg.example.com"
web_domain                 = "app.stg.example.com"
...
lambda_artifact_bucket     = "platform-artifacts-000000000000"
